...
!(function (t, e) {
    ...
    (function (t, e) {
        ...
        return (
            (s.updateGetPathSelector = function (t) {
                ...
                for (
                    var i, n, o = e.getAttribute("href"), r = 0; o && r < h.length; r++
                ) {
                    n = h[r];
                    var s = o.match(n);
                    if (s) {
    ...
    (function (t, e) {
        ...
        function i(t) {
            for (
                var e = document.createDocumentFragment(), i = 0; t && i < t.length; i++
            )
                e.appendChild(t[i]);
            return e;
        }
    ...
    (function (t, e) {
        ...
        return (
            ...
            (n.onScrollHistory = function () {
                for (
                    var t, e, i = this.getScrollViewY(), n = 0; n < this.scrollPages.length; n++
                ) {
